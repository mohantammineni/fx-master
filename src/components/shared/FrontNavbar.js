  ...
  return (
    <header className="sticky top-0 w-full flex flex-col md:flex-row items-center justify-between md:pl-12 md:pr-12 pt-2 pb-2 bg-white shadow-md z-50">
      ...
      <div className="flex items-center md:mb-0">
        <img src="/fx_logo.png" alt="FX Master Logo" className="mr-4" />
      </div>
      ...
      <div className="flex items-center space-x-4">
        ...
        <NavLink to='/login' className="bg-custom-dark-blue text-custom-yellow py-2 px-4 rounded-full">
          User Sign-In
        </NavLink>
        <NavLink to='/stafflogin' className="bg-custom-dark-blue text-custom-yellow py-2 px-4 rounded-full">
          Staff Sign-In
        </NavLink>
