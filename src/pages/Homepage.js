...
function Homepage() {
  ...
  return (
    <>
      <div className="grid text-center px-12 py-4 mt-16 gap-8 items-start">
        <div className="flex flex-col font-openSans justify-center mt-4">
          ...
          <div className="flex gap-4 mt-6 justify-center">
            ...
            <a target='_blank' rel="noreferrer noopener" href="https://play.google.com/store/apps/details?id=com.fxmaster&hl=en-IN">
              <img
                src="/google-play.png"
                alt="Google Play"
                className="w-[170px] h-[50px]"
