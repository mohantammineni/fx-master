...
function AddBalance() {
  ...
  return (
    <div className="my-2">
      ...
      <div
      style={{display:'none'}}
        className="bg-gradient-to-r from-[#205FFF] to-[#1152BE] rounded-3xl shadow-lg p-6 flex items-center justify-between text-white">
      ...
      <div className="bg-white rounded-3xl p-6 shadow-lg my-4">
        ...
        <div className="flex justify-around items-center mt-6" style={{display:'none'}}>
          <button
            onClick={() => {
              setcardtype('visa');
              getConversionData(amount, 'visa');
        ...
        <div className="text-center my-6" style={{display:'none'}}>
          {
        ...
        <div className="text-center my-4 text-lg font-semibold" style={{display:'none'}}>OR</div>
