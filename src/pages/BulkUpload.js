                    ...
                    {currentItems &&
                        currentItems.map((item, index) => {
                            return (
                                <>
                                    {index == 0 &&
                                        <tr style={{ borderWidth: 2, borderColor: '#1152BE', fontSize: 12, borderRadius: 10 }} key={index} className='text-sm'><td>Type</td><td>First Name</td><td>Last Name</td><td>Reason</td><td>Amount</td><td>Mobile</td><td>Country Name</td><td>Code Type</td><td>Account Name</td><td>Code</td><td>Account Number</td><td>Address</td><td>Company Name</td><td>Currency</td></tr>}
