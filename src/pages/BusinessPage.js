    ...
    <>
      <section className="relative w-full min-h-screen">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start justify-between h-full pt-4 md:pt-8">
          {/* Text Container */}
          <div className="max-w-lg md:max-w-none md:text-left md:w-1/2 pl-6 pr-6 md:pl-10 md:pr-0 pt-12 text-white">
            <h1 className="text-4xl md:text-3xl font-montserrat font-bold tracking-wide">
              Your Partner in Global Business Transactions
            </h1>
            <div className="border-b-4 border-white w-24 mt-2"></div>
            <p className="mt-4 w-[72%] md:w-full text-sm md:text-lg font-bold font-openSans">
      ...
      <section className="px-12 py-6 mt-6">
        <h2 className="text-4xl font-montserrat font-bold text-custom-dark-blue tracking-wide">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 pt-5">
          <div className="bg-white rounded-2xl shadow-md p-4">
            ...
            />
            <h3 className="text-lg font-bold font-montserrat text-black mb-2">
              Competitive Exchange Rates:
            </h3>
            <p className="text-sm text-[#425466] font-openSans font-bold">
      ...
      <section id="services" className="px-12 py-6 mt-6">
        <h2 className="text-4xl font-montserrat font-bold text-custom-dark-blue tracking-wide">
      ...
      <section className="px-12 py-6 mt-6">
        <div className="bg-custom-dark-blue text-white py-12 px-6 rounded-lg">
          <h2 className="text-center text-3xl font-bold font-montserrat mb-8">
      ...
      <section className="px-12 py-6">
        <h2 className="text-4xl font-bold font-montserrat text-blue-700">
      ...
      >
        ...
        <div className="relative flex justify-center items-center h-full px-4">
          <div className="bg-white rounded-2xl p-8 max-w-2xl w-full text-center">
            <h1 className="text-3xl font-extrabold text-black font-montserrat mb-4">
              Get Started Today
            </h1>
            <div className="mx-auto w-[75%]">
              <p className="text-base font-semibold font-openSans text-[#0F51BC]">
      ...
      <section id="contact" className="container mx-auto rounded-2xl mt-12 mb-12 px-12">
        <ContactInformation />
      </section>
    </>
  );
